...
const CFG = {
  ...
  cardGood:[
    "현재 당신의 몸 상태는 전반적으로 안정적이에요. 카드가 보여주는 건 내면의 생명 에너지가 활발하게 흐르고 있다는 신호예요. 지금 느끼는 작은 피로나 불편함은 몸이 더 강해지기 위해 스스로 조율하는 과정일 수 있어요. 현재의 건강한 습관들을 꾸준히 유지하는 것이 가장 중요해요. 오행 중 당신의 기운이 강한 오행에 맞는 색상 옷을 입거나 음식을 먹으면 기력 회복이 빨라요.",
    "주의해야 할 부분에서 카드가 좋은 기운을 보내고 있어요. 걱정하고 있는 건강 문제가 있다면, 지금 당장 심각한 상황은 아니에요. 하지만 방심은 금물이에요. 지금 이 기회에 예방적 관리를 시작하면 훨씬 좋은 결과를 얻을 수 있어요. 정기 검진을 미루고 있었다면 이번 달 안에 받아보세요. 몸의 면역 기운이 살아 있는 시기예요.",
    "카드가 전하는 건강 조언은 지금이 새로운 건강 습관을 시작하기에 완벽한 타이밍이라는 거예요. 운동이든, 식단이든, 수면 패턴이든 한 가지만 바꿔도 몸 전체에 긍정적인 변화가 일어날 거예요. 특히 취약한 오행 기운을 보충하는 것이 포인트예요. 작은 것부터, 오늘부터 시작하세요.",
  ],
  cardBad:[
    "몸이 지금 과부하 상태일 수 있어요. 카드는 당신의 몸이 쉬고 싶다는 신호를 보내고 있어요. 최근에 잠을 제대로 못 자거나, 식사를 건너뛰거나, 스트레스가 쌓이진 않았나요? 지금 당장 하루 이틀이라도 완전히 쉬는 것이 가장 좋은 처방이에요. 사주의 약한 오행 부위 — 간·담·소화기 등 — 를 특히 신경 써보세요.",
    "주의해야 할 건강 신호가 있어요. 이 카드는 오랫동안 무시해온 작은 증상이나 불편함이 있다면 지금 확인하라고 경고하고 있어요. 귀찮거나 바빠서 미뤄온 검진이나 치료가 있다면 더 이상 미루지 마세요. 초기에 발견하면 해결하기 훨씬 쉬워요. 신체 중 허리·관절·두통 쪽을 우선 점검해보세요.",
    "카드가 전하는 건강 조언은 근본적인 생활 습관의 변화가 필요하다는 거예요. 임시방편으로 대처하는 것으로는 부족해요. 수면, 식사, 운동, 스트레스 관리 중에서 가장 취약한 부분을 찾아 집중적으로 개선해보세요. 특히 신경계와 소화기 계통에 피로가 쌓이기 쉬운 시기예요. 전문가의 도움을 받는 것도 좋은 방법이에요.",
  ],
  synGood:"3장의 카드가 전반적으로 안정적인 건강 기운을 보여줘요. 규칙적인 생활 패턴이 핵심이에요. 지금 관리하면 충분히 좋아질 수 있어요. 오행별 취약 부위를 미리 파악해 예방하는 것이 장수의 비결이에요.",
  synBad:"카드가 경고 신호를 보내고 있어요. 지금 당장 생활 습관을 점검하고, 필요하다면 전문가를 찾아보세요. 스트레스가 몸의 가장 약한 오행 부위를 먼저 공격해요.",
};
    ...
    <div style={{minHeight:"100vh",background:"#111827",fontFamily:"'Noto Serif KR',serif",maxWidth:430,margin:"0 auto",paddingBottom:80}}>
      ...
      <div style={{padding:"14px 14px 0"}}>
            ...
            <div style={{background:"#fff",border:cd.isGood?"2px solid rgba(46,125,50,0.25)":"2px solid rgba(198,40,40,0.2)",borderRadius:16,padding:"18px",marginBottom:12,boxShadow:"0 4px 20px rgba(0,0,0,0.15)"}}>
              ...
              <div style={{background:"#F9F7F2",borderRadius:10,padding:"12px 14px",marginBottom:12}}>
                ...
                <p style={{fontSize:12,color:"#333",lineHeight:1.85,margin:0}}>
                  {cd.isGood
                    ?"지금 이 자리에서 긍정적인 에너지가 흐르고 있어요. 이 자리는 "+DEMO_NAME+"님의 건강 관리에서 중요한 신호예요. 지금 몸이 보내는 이 긍정적인 기운을 실제 습관으로 이어가보세요. 작은 루틴 하나가 건강을 지켜줘요."
        ...
        <div style={{background:"#fff",borderRadius:16,padding:"18px",marginBottom:12,boxShadow:"0 4px 20px rgba(0,0,0,0.12)"}}>
          <p style={{fontSize:9,color:"#7A5C00",letterSpacing:3,margin:"0 0 14px"}}>🌿 건강 영역별 상세 분석</p>
          {[
            {area:"체력·에너지",emoji:"💪",score:isGood?74:52,
             text:isGood?DEMO_NAME+"님, 체력 자체는 나쁘지 않아요. 근데 에너지를 한 번에 다 쓰고 방전되는 패턴이 있어요. 꾸준히 조금씩 쓰는 연습이 필요해요. 오늘 기운이 좋다고 무리하면 내일 쓰러지는 타입이에요. 지금 이 에너지를 아껴서 써보세요.":DEMO_NAME+"님, 지금 체력이 많이 소진되어 있어요. 몸이 보내는 신호를 더 이상 무시하면 안 돼요. 무리한 스케줄을 줄이고 회복에 집중해야 할 때예요. 지금 쉬는 게 나중에 더 많이 할 수 있는 방법이에요."},
            {area:"수면·피로",emoji:"😴",score:isGood?68:45,
             text:isGood?"수면의 질이 중요한 시기예요. 양보다 질이에요. 일정한 시간에 자고 일어나는 루틴을 만들어보세요. 자기 전 스마트폰을 내려놓는 것만으로도 수면의 질이 크게 달라져요.":"수면 부족이나 수면의 질 저하가 다른 건강 문제로 이어질 수 있어요. 카드가 지금 당장 수면 패턴을 바꾸라고 강하게 경고하고 있어요. 오늘부터 자정 전에 자는 습관을 만들어보세요."},
            {area:"멘탈·스트레스",emoji:"🧠",score:isGood?71:48,
             text:isGood?"정신적 에너지가 충분해요. 이 상태를 유지하려면 과부하가 걸리기 전에 미리 쉬어가는 게 중요해요. 스트레스를 느끼기 전에 예방적으로 관리하는 게 "+N+"님 체질에 맞는 방식이에요.":"정신적 스트레스가 이미 몸에 영향을 주고 있어요. 지금 억누르고 있는 감정이 있다면 풀어야 해요. 신뢰할 수 있는 사람과 이야기를 나누거나, 운동이나 글쓰기로 해소하는 방법을 찾아보세요."},
          ].map(function(r){return(
            <div key={r.area} style={{marginBottom:18}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
                <p style={{fontSize:13,fontWeight:700,color:"#111",margin:0}}>{r.emoji} {r.area}</p>
                <span style={{fontSize:12,fontWeight:700,color:r.score>=60?"#2E7D32":"#C62828"}}>{r.score}점</span>
              </div>
              <div style={{height:6,background:"#F0EDE6",borderRadius:99,overflow:"hidden",marginBottom:10}}>
                <div style={{height:"100%",width:r.score+"%",background:r.score>=60?"linear-gradient(90deg,#7CB87B,#2E7D32)":"linear-gradient(90deg,#FF7675,#C62828)",borderRadius:99}}/>
              </div>
        ...
        {/* ⑤ 오늘부터 실천 루틴 */}
        <div style={{background:"#fff",borderRadius:16,padding:"18px",marginBottom:12,boxShadow:"0 4px 20px rgba(0,0,0,0.12)"}}>
          <p style={{fontSize:9,color:"#7A5C00",letterSpacing:3,margin:"0 0 14px"}}>⚡ {DEMO_NAME}님, 오늘부터 시작하는 건강 루틴</p>
          {(isGood?[
            "🌅 아침 기상 후 물 한 잔 마시기 — 간 기능 활성화에 좋아요",
            "🚶 하루 30분 걷기 — 심폐 기능과 소화 기능을 동시에 챙길 수 있어요",
            "🥗 초록 채소 하루 한 번 — 목 기운을 보충하는 음식이에요",
            "📵 자기 1시간 전 스마트폰 끄기 — 수면의 질을 높여줘요",
            "😮‍💨 깊게 호흡하기 3분 — 스트레스 호르몬 수치를 낮춰줘요",
          ]:[
            "🛑 오늘 야근·무리한 일정 취소하기 — 몸이 먼저예요",
            "💧 물 최소 1.5리터 마시기 — 독소 배출에 가장 기본이에요",
            "🌙 오늘 자정 전 취침 — 지금 몸에게 가장 필요한 것이에요",
            "🚫 음주·자극적 음식 오늘 하루 피하기 — 회복에 집중해야 해요",
            "🏥 오래 미뤄온 검진이 있다면 이번 주 안에 예약하기",
          ]).map(function(t,i){return(
            <p key={i} style={{fontSize:12,color:"#333",lineHeight:1.85,margin:"0 0 8px",paddingLeft:10,borderLeft:"2px solid rgba(124,184,123,0.5)"}}>{t}</p>
          );})}
        </div>

        {/* ⑥ 건강 행운 정보 */}
        <div style={{background:"#fff",borderRadius:16,padding:"18px",marginBottom:12,boxShadow:"0 4px 20px rgba(0,0,0,0.12)"}}>
          <p style={{fontSize:9,color:"#7A5C00",letterSpacing:3,margin:"0 0 14px"}}>🍀 {DEMO_NAME}님의 건강 행운 정보</p>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            {[["🥗","행운 음식","녹색 채소·두부·콩"],["🎨","건강 컬러","초록·청록색"],["⏰","좋은 운동 시간","오전 7~9시"],["📅","건강 길일","목요일·음력 8일"],["🏥","주의 부위","소화기·간·담"],["⚠️","주의 시기","환절기·스트레스 과다"]].map(function(x){return(
        ...
        <div style={{background:"linear-gradient(135deg,rgba(232,200,122,0.12),rgba(232,200,122,0.06))",border:"1px solid rgba(232,200,122,0.3)",borderRadius:16,padding:"20px 18px",marginBottom:12,textAlign:"center"}}>
          <p style={{fontSize:15,color:"#7A5C00",fontWeight:800,lineHeight:1.75,margin:"0 0 8px",wordBreak:"keep-all"}}>{isGood?'💫 규미님, 꾸준히 관리하는 것이 최고의 건강 비결이에요. 잘 하고 있어요!':'💫 규미님, 몸의 소리에 귀 기울이는 것이 용기예요. 지금 꼭 챙겨주세요.'}</p>
