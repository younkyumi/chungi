...
const TYPES_16 = [
  ...
  { code:"음지정강", hanja:"陰地情剛", mbti:"ISFJ", name:"옥토", emoji:"🌾", color:"#AED581", shared:false,
...
const GUARDIANS_12 = [
  ...
  { name:"옥토", hanja:"玉兎", emoji:"🌙", color:"#69F0AE", bgColor:"#0a2a1a",
    ...
    lucky:"초록·흰색, 서쪽·북쪽",
    celeb:"뉴진스 민지, 헤르만 헤세" },
  { name:"신구", hanja:"神龜", emoji:"⭐", color:"#D4AC0D", bgColor:"#2a2000",
    subtitle:"우주의 비밀을 등에 새긴 영원한 수호자",
    element:"토(土)·수(水)", ohang:"토·수",
    desc:"등껍질에 우주의 비밀을 새긴 신령한 거북. 안정감과 깊은 지혜, 영원함을 상징.",
