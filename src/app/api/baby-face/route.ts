...
- 2명 이상(한 사진에): {"image_type":"multi","type_id":23}
  ⚠️ multi는 **한 사진에 얼굴 크기가 비슷한 사람이 둘 이상이라 누가 부모인지 모호할 때만** 쓴다.
     배경의 작은 행인·군중, 뒤쪽 흐린 사람, 액자·포스터 속 인물은 무시하고
     **가장 크고 선명한 정면 얼굴 한 명**을 기준으로 분석할 것.
...
- 그림/캐릭터: {"image_type":"illustration","type_id":26}
  ⚠️ 카메라로 찍은 사진은 아무리 잘 찍히고 보정돼 있어도 실사다.
     스튜디오 프로필·웨딩·화보·보정 셀카를 illustration으로 판정하지 말 것.
