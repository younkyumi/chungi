    ...
    <div style={{minHeight:"100vh",background:"#111827",fontFamily:"'Noto Serif KR',serif",maxWidth:430,margin:"0 auto",paddingBottom:60}}>
      <div style={{background:DG,padding:"20px 16px 16px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          <div><h2 style={{fontSize:22,fontWeight:700,color:"#F0EAD6",margin:"0 0 4px"}}>🦶 발금 풀이</h2>
            <p style={{fontSize:12,color:"rgba(255,255,255,0.5)",margin:0}}>손금보다 정확하다는 발바닥의 비밀</p></div>
      ...
      <div style={{padding:"14px 16px"}}>
        <div style={{background:DG,borderRadius:16,padding:"16px",marginBottom:12}}>
          <p style={{fontSize:9,color:G,letterSpacing:3,margin:"0 0 12px"}}>🦶 발금학 — 손금보다 솔직한 운명의 지도</p>
          <FootSilhouette/>
          <div style={{background:"rgba(232,200,122,0.08)",borderRadius:10,padding:"10px 14px",marginTop:12}}>
            <p style={{fontSize:11,color:G,fontWeight:700,margin:"0 0 5px"}}>💡 왜 발금이 손금보다 정확할까요?</p>
            <p style={{fontSize:11,color:"rgba(255,255,255,0.6)",lineHeight:1.65,margin:0}}>손은 후천적 노력으로 변하지만, 발은 타고난 기질과 운명을 더 솔직하게 담고 있어요. 발을 꾸미는 사람은 손보다 훨씬 적기 때문에 원본 정보가 더 많이 남아있어요.</p>
          </div>
        </div>
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:14,padding:"16px",marginBottom:12}}>
          <p style={{fontSize:9,color:G,letterSpacing:3,margin:"0 0 14px"}}>✦ 발금 풀이에서 알 수 있는 것</p>
        ...
        <div style={{background:"rgba(232,200,122,0.08)",border:"1px solid rgba(232,200,122,0.2)",borderRadius:12,padding:"12px 14px",marginBottom:12}}>
          ...
          <p style={{fontSize:11,color:"rgba(255,255,255,0.55)",lineHeight:1.65,margin:0}}>발바닥 전체가 나오게 촬영하세요<br/>밝은 조명에서 발가락 쫙 펴서 촬영<br/>발등 아닌 발바닥이 찍혀야 해요!</p>
        </div>
  ...
  if(step==="payment") return(
    <div style={{minHeight:"100vh",background:"#111827",fontFamily:"'Noto Serif KR',serif",maxWidth:430,margin:"0 auto",paddingBottom:60}}>
      ...
      <div style={{padding:"16px"}}>
        ...
        <div style={{height:12}}/><GBtn onClick={function(){setStep("loading");}}>발금 분석하기 (380원) →</GBtn>
